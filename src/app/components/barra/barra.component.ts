...
export class BarraComponent {
  ...
  public barChartData:any[] = [
    {data: [37, 44, 42, 45, 18, 6, 8, 11, 9, 17, 16, 37], label: '10-2 QUEMA DE MATORRALES'},
    {data: [11, 17, 10, 20, 15, 28, 13, 27, 29, 19, 16, 21], label: '10-4-1 ACCIDENTE DE TRANSITO'},
    ...
    {data: [28, 28, 20, 19, 36, 47, 40, 54, 54, 26, 27, 29], label: '10-0-1 INFLAMACIÓN DE CHIMENEA'},
    {data: [15, 19, 18, 18, 16, 15, 14, 18, 17, 19, 15, 17], label: '10-10-02 INCENDIO DECLARADO CON MATERIALES PELIGROSOS'}
  ];
